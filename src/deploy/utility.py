...
def create_bedrock_execution_role(bucket_name,account_number,region_name):
...
def create_oss_policy_attach_bedrock_execution_role(collection_id, bedrock_kb_execution_role,account_number,region_name):
            ...
            [
                {
                    ...
                    'Principal': [bedrock_kb_execution_role_arn,identity],
...
def delete_iam_role_and_policies(account_number):
